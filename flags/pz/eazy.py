...
def get_templates(template_set, path_to_EAZY=os.getenv('EAZY')):
    ...
    params = ascii.read(f'{path_to_EAZY}/templates/{template_set}', names=[
...
def default_params(EAZY_working_dir):
    ...
    params['NMF_TOLERANCE'] = 1.e-4
    # Wavelength grid definition file
    params['WAVELENGTH_FILE'] = f'templates/EAZY_v1.1_lines/lambda_v1.1.def'
    # Template error definition file
    params['TEMP_ERR_FILE'] = f'templates/TEMPLATE_ERROR.eazy_v1.0'
    ...
    params['OUTPUT_DIRECTORY'] = f'{EAZY_working_dir}/outputs'
